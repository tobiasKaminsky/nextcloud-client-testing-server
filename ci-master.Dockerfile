...
RUN rm /etc/apt/sources.list.d/php.list && apt-get update && apt-get install -y composer
...
RUN su www-data -c "git clone --depth 1 -b master https://github.com/nextcloud/activity.git /var/www/html/apps/activity/"
...
RUN su www-data -c "git clone --depth 1 -b master https://github.com/nextcloud/end_to_end_encryption/  /var/www/html/apps/end_to_end_encryption/"
RUN su www-data -c "php /var/www/html/occ app:enable end_to_end_encryption"
RUN su www-data -c "git clone --depth 1 -b master https://github.com/nextcloud/password_policy/  /var/www/html/apps/password_policy/"
RUN su www-data -c "php /var/www/html/occ app:enable password_policy"
RUN su www-data -c "git clone --depth 1 -b master https://github.com/nextcloud/external/  /var/www/html/apps/external/"
...
RUN su www-data -c "git clone --depth 1 -b main https://github.com/nextcloud/files_lock.git /var/www/html/apps/files_lock/"
RUN su www-data -c "php /var/www/html/occ app:enable -f files_lock"
RUN su www-data -c "git clone --depth 1 https://github.com/nextcloud/groupfolders.git /var/www/html/apps/groupfolders/"
...
RUN su www-data -c "git clone --depth 1 https://github.com/nextcloud/notifications.git /var/www/html/apps/notifications/"
RUN su www-data -c "cd /var/www/html/apps/notifications; composer install --no-dev"
...
RUN su www-data -c "git clone --depth 1 https://github.com/nextcloud/photos.git /var/www/html/apps/photos/"
...
RUN su www-data -c "git clone --depth 1 https://github.com/nextcloud/assistant.git /var/www/html/apps/assistant/"
...
RUN su www-data -c "git clone --depth 1 https://github.com/nextcloud/files_downloadlimit.git /var/www/html/apps/files_downloadlimit/"
RUN su www-data -c "php /var/www/html/occ app:enable -f files_downloadlimit"
RUN su www-data -c "git clone --depth 1 -b master https://github.com/nextcloud/recommendations.git /var/www/html/apps/recommendations/"
RUN su www-data -c "php /var/www/html/occ app:enable -f recommendations"
RUN su www-data -c "php /var/www/html/occ config:system:set ratelimit.protection.enabled --value false --type bool"
