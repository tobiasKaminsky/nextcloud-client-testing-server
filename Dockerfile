...
# RUN su www-data -c "git clone --depth 1 -b $BRANCH https://github.com/nextcloud/contacts.git /var/www/html/apps/contacts/"
# RUN su www-data -c "php /var/www/html/occ app:enable -f contacts"
RUN su www-data -c "git clone --depth 1 -b $BRANCH https://github.com/nextcloud/circles.git /var/www/html/apps/circles/"
RUN su www-data -c "php /var/www/html/occ app:enable -f circles"
